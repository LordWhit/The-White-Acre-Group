    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container-padding relative z-10 flex flex-col items-center text-center max-w-4xl">
          ...
          >
            <Link href="/business-owners">
              <Button size="lg" className="bg-white text-primary hover:bg-white/90 font-serif text-lg h-14 px-8 min-w-[200px]">
                Business Owners
              </Button>
            </Link>
            <Link href="/investors">
              <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 font-serif text-lg h-14 px-8 min-w-[200px]">
                Investors & Partners
              </Button>
            </Link>
          </motion.div>
            ...
            {[
              {
                ...
                description: "We understand that your business is your life's work. We honor the culture and reputation you've built over decades."
              },
              {
                icon: Users,
                title: "People First",
                description: "Employees are the heartbeat of any company. We commit to no mass layoffs and preserving the team that made the business successful."
              },
              {
                icon: TrendingUp,
      ...
      <section className="section-padding bg-primary text-white text-center">
        <div className="container-padding max-w-4xl">
          <h2 className="text-3xl md:text-5xl font-serif font-bold mb-6">Ready to discuss the next chapter?</h2>
          <p className="text-lg md:text-xl text-white/70 mb-10 max-w-2xl mx-auto">
            Whether you are an owner considering a transition or an investor seeking stable returns, let's start a confidential conversation.
          </p>
          <Link href="/contact">
            <Button size="lg" className="bg-white text-primary hover:bg-white/90 font-serif text-lg h-14 px-10">
              Get in Touch
            </Button>
          </Link>
        </div>
