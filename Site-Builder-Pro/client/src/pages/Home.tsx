          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              },
              {
                ...
                description: "Unlike private equity firms with five-year clocks, we hold indefinitely and make decisions for the next generation.",
              },
            ].map((feature, i) => (
              <motion.div
                key={i}
            ...
            <div>
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-lg text-primary/80">
